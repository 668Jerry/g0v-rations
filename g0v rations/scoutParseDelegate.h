...
@interface scoutParseDelegate : NSObject <NSXMLParserDelegate>
{
    //<失業率>
    //<資料時期>1978</資料時期>
    //<總計>1.67</總計>
...
@property NSString *nssTheColumnName;
@property int iTheColumnHirachy;
@property int iTheColumnHirachyRepeatTime;
